...
describe('getData', () => {
  ...
  it('should return a huge Star Wars object', () => {
  ...
  it('should return an error for a response that is not ok', () => {
    ...
    expect(getData()).rejects.toEqual(Error('Error fetching data'));
  });
});
...
describe('getFilm', () => {
  ...
  it('should fetch the correct URL', () => {
    getFilm('https://swapi.co/api/films/2/');

    expect(window.fetch).toHaveBeenCalledWith('https://swapi.co/api/films/2/');
  });

  it('should return a huge film object', () => {
    expect(getFilm()).resolves.toEqual(mockResponse);
  });
  ...
  it('should return an error for a response that is not ok', () => {
    ...
    expect(getFilm()).rejects.toEqual(Error('Error fetching film data'));
  })
});
...
describe('getSpecies', () => {
  ...
  it('should fetch the correct URL', () => {
    getSpecies('https://swapi.co/api/species/1/');

    expect(window.fetch).toHaveBeenCalledWith('https://swapi.co/api/species/1/');
  });

  it('should a huge species object for a response that is ok', () => {
    expect(getSpecies()).resolves.toEqual(mockResponse)
  });
  ...
  it('should return an error for a response that is not ok', () => {
    ...
    expect(getSpecies()).rejects.toEqual(Error('Error fetching species data'));
  })
});
...
describe('getWorld', () => {
  ...
  it('should fetch the correct URL', () => {
    getWorld('https://swapi.co/api/planets/9/');

    expect(window.fetch).toHaveBeenCalledWith('https://swapi.co/api/planets/9/');
  });

  it('should a huge species object for a response that is ok', () => {
    expect(getWorld()).resolves.toEqual(mockResponse)
  });
  ...
  it('should return an error for a response that is not ok', () => {
    ...
    expect(getWorld()).rejects.toEqual(Error('Error fetching world data'));
  })
});
...
describe('getCharacter', () => {
  ...
  it('should return an error for a response that is not ok', () => {
    ...
    expect(getCharacter()).rejects.toEqual(Error('Error fetching character data'));
  })
})
